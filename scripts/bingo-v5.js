bingo = function (bingoList, size, bingoListVersion) {
	bingoListVersion = typeof bingoListVersion !== 'undefined' ? bingoListVersion : 0;
    ...
    if (SEED == "") {
        ...
        var results = $("#results");
        results.append("<p>SRL Bingo <strong>v5</strong>&emsp;List Version: <strong>" + bingoListVersion + 
		"</strong>&emsp;Seed: <strong>" + SEED + "</strong>&emsp;Card type: <strong>" + cardtype + "</strong></p>");
        ...
        for (i = 1; i <= 25; i++) {
            ...
            //$('#slot' + i).append(bingoBoard[i].difficulty.toString());
